...
This section includes selected academic and practical projects related to machine learning, AI, SQL, and data visualization, reflecting hands-on learning and applied problem-solving across different tools and datasets.
...
- Power BI Dashboard Project:Worked on Superstore dataset to visualize the data and drawn the insights.
